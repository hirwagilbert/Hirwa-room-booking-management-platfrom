...
<!----dropdown content-- css----><style>
        ...
        .dropdown-content {
          ...
          min-width: 16px;
          box-shadow: 0px 8px 16px 0px yellow;
          z-index: 1;
          border-radius: 20PX;
        }
...
.sales-details button[name="delete"] {
        ...
        <ul class="nav-links">
          ...
          <li>
              ...
              <div class="dropdown-content">
                <a href="deleteclientmanager.html"class="active">Delete</a>
                <a href="blockclient_manager.html">Block</a>
          ...
          <li>
             ...
             <div class="dropdown"> <span class="links_name">rooms</span>
                    ...
                    <div class="dropdown-content">
                      ...
                      <a href= "edit&delete_manager.html">Add & Edit & Delete</a>
        ...
        <div class="sales-boxes">
          <div class="recent-sales box">
            ...
            <div class="sales-details">
                ...
                <div class="sales-details" >
                    <form id="accountForm"  >
                      <label for="email" style="color:white;">Enter the Email account of client to delete:</label>
