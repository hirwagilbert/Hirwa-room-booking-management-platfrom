...
<html lang="en">
    ...
    <!-- Favicons -->
        ...
        <link href="img/apple-favon.png" rel="apple-touch-icon">
    ...
    <body>
        ...
        <header id="header">
            <a href="hotel.html" class="logo"><img src="L.jpg" alt="logo"></a>
            <div class="phone"><butt class="fa -phone"></button></div>
            ...
            <nav class="main-menu top-menu">
                <button>
                    ...
                    <li><a href="serviceforhotel.html">SERVICES</a></li>
        ...
        <div id="search" style="background: black;">
            <div class="container">
                <div class="form-row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="room-des">
                                    <h3><a href="index.html" data-toggle="modal" data-target="#modal-id" >Silver Double</a></h3>
                                    <p></p>
                                    <ul class="room-size">
                                        <li><i class="fa fa-arrow-right"></i>Size: 200 sq ft </li>
                                        <li><i class="fa fa-arrow-right"></i>Beds: 2 Double(s) </li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="port-slider">
                                    <div><img src="img/room-slider/room-1.jpg"> room 12</div>
                                    <div><img src="img/room-slider/room-2.jpg">room 13</div>
                                    <div><img src="img/room-slider/room-3.jpg">room 14</div>
                                    <div><img src="img/room-slider/room-4.jpg">room 15</div>
                                    <div><img src="img/room-slider/room-5.jpg">room 16</div>
                                    <div><img src="img/room-slider/room-6.jpg">room 17</div>
                                </div>
                            ...
                            <div class="col-12">
                                <h2>Hotel Rooms</h2>
                                <p>
                            Enjoy modern amenities, stunning views, and personalized service that will exceed your expectations. Whether you're traveling for business or leisure, our rooms provide the perfect retreat for a truly unforgettable stay. Book your room today and indulge in the ultimate blend of opulence and comfort.
                                </p>
                                <div class="modal-link">
                                    <a href="login2.php">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
      ...
      <button><a href="rooms.html">OTHER ROOMS</a></button>
        </div>
